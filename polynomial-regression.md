...
이때 얻어진 [결정계수(Coefficient of determination)](https://github.com/kyopark2014/ML-Algorithms/blob/main/evaluation.md#coefficient-of-determination)는 아래와 같습니다. test 결과가 train 결과보다 좋으므로 과소적합에 해당 됩니다. 
