...
여기의 데이터는 [혼자 공부하는 머신러닝+딥러닝](https://github.com/rickiepark/hg-mldl)을 이용합니다. [logistic_regression.ipynb](https://github.com/kyopark2014/ML-Algorithms/blob/main/src/logistic_regression.ipynb)를 아래와 같이 설명합니다.
